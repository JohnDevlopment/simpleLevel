...
add_library (timer_class STATIC timer_class.cpp)
...
# set compile options
if (${DEBUG})
  target_compile_options (level_editor PRIVATE "SHELL:-g")
  message ("Debug build")
endif ()
...
target_link_options (level_editor
	PRIVATE
	  "LINKER:-rpath,/usr/local/lib,--enable-new-dtags"
	  "SHELL:-L${SDL2_LIBDIR}"
	)
